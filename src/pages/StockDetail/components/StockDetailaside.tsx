...
const MOCK_COMPANY: CompanyInfo = {
  ...
  stats: {
    marketCap: '1,086조 2,535억',
    exchange: '코스피 1위',
    shares: '59.2억 주',
    foreignRatio: '49.66%',
    compareIndustry: '하드웨어/IT장비',
    comparePeer: '반도체/반도체장비',
    low52w: '52,900',
    high52w: '228,500',
  },
  overview:
    '삼성전자는 1969년 설립된 기업으로 반도체, 전자 제품 제조·판매업을 영위하고 있다. 메모리 반도체(DRAM·NAND), 시스템 반도체(AP·이미지센서), 디스플레이 패널, 스마트폰·가전 사업 부문으로 구성된다.',
  performance: [
    {
      year: '2023.12',
      revenue: '258조',
      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden">
        ...
        <div className="mt-2 bg-white px-4 py-4">
          <div className="divide-y divide-[#f2f4f7]">
            ...
            <div className="py-4">
              <p className="mb-2 text-[11px] font-medium text-[#98a2b3]">
                비교기업
              </p>
              <div className="grid grid-cols-2 divide-x divide-[#f2f4f7]">
                <StatCell
                  label="업종"
                  value={company.stats.compareIndustry}
                />
                <StatCell
                  label="동종업계"
            ...
            {[
              ...
              return (
                ...
                >
                  ...
                  <span className="text-[16px] font-semibold tracking-[-0.01em] text-[#101828]">
                    {value}
                  </span>
                  <span
